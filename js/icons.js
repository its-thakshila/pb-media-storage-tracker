// ============================================================
//  icons.js - Inline Lucide SVG icon helpers
//  No external dependency. All icons are 18x18 Lucide strokes.
//  Usage: Icons.home(), Icons.bell(), etc. - returns SVG string.
// ============================================================
...
const Icons = (() => {
  const svg = (paths, extra = "") =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
      ...
      stroke-linecap="round" stroke-linejoin="round" class="icon" ${extra}>${paths}</svg>`;
